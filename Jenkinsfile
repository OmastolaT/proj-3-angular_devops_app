pipeline {
  ...
  parameters {
    string(name: 'RELEASE_TAG', defaultValue: '', description: 'Optional release tag (e.g. v1.0.0). If empty Jenkins will generate a timestamped version')
    string(name: 'ROLLBACK_TO', defaultValue: '', description: 'If set, rollback to this version on the app server (e.g. v1.0.0-20250927-001)')
  }
